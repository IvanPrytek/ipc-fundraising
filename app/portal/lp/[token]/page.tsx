...
import { validateToken, getMilestones, getStatusUpdates, getFundMetrics } from "@/lib/portal/queries";
...
export default function LPOverviewPage({ params }: { params: Promise<{ token: string }> }) {
