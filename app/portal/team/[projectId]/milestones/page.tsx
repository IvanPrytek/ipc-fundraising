...
export default function TeamMilestonesPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return <MilestoneList milestones={milestones} projectId={projectId} editable={true} onMilestonesChange={setMilestones} />;
}
